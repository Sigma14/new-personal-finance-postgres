...
SUGGESTED_SUB_CATEGORIES = {
    "Entertainment": [
        "Concerts", "Movies", "Music", "Games", "Hobbies"
    ],
    "Food": [
        "Groceries", "Eating Out"
    ],
    "Healthcare": [
        "Doctor", "Fitness", "Dentist", "Pharmacy", "Health"
    ],
    "Housing": [
        "Mortgage", "Rent", "Hoa Fees", "Home Improvement"
    ],
    "Personal Care": [
        "Hair", "Shopping", "Electronic Items", "Beauty", "Spa", "Clothes"
    ],
    "Transportation": [
        "Ride Share", "Parking", "Public Transportation", "Fuel"
    ],
    "Bills & Subscriptions": [
        "Electricity", "Water", "Cellphone", "Internet",
        "Spotify Subscription", "Netflix Spotify Subscription",
        "Amazon Prime Spotify Subscription"
    ],
    "Goals": [
        "Phone", "Vacation", "Education", "Wedding", "Home Improvement"
    ],
    "Income": [
        "Job", "Business", "Bonus"
    ],
    "Non-Monthly": [
        "Taxes", "Car Maintenance", "Medical Expenses", "Insurance",
        "Gifts", "Holidays", "Insurance"
    ]
}

# Expense category group list
GROUP_LIST = [
    "Entertainment", "Food", "Healthcare", "Housing", "Personal Care", "Transportation"
]
...
CATEGORIES_DICT = {
    ...
    "Goals": [
        "Phone", "Vacation", "Education", "New Car", "New House", "Electronic", "Other"
    ],
    "Funds": [],
    "Food": [
        "Groceries", "Eating Out"
...
MORTGAGE_ACCOUNT_TYPES = (
    "Mortgage", "Loan", "Student Loan", "Personal Loan",
    "Medical Debt", "Other Loan", "Other Debt"
)

# Mortgage Keywords
MORTGAGE_KEYWORDS = (
    "Mortgage", "Loan", "Mortgages", "Loans", "Mortgages and Loans", "Mortgages & Loans"
)
