...
urlpatterns = [
    ...
    path(
        "subcategory_suggestion", subcategory_suggestion, name="subcategory_suggestion"
    ),
    # Budget urls :-
    ...
    path(
        ...
        name="compare-target-budgets",
    ),
    path(
        "budgets/compare/different",
        compare_different_budget_box,
        name="compare-different-budgets",
    ),
    ...
    path(
        ...
        name="budgets_walk_through",
    ),
    path(
        "budgets/income/walk_through",
        budgets_income_walk_through,
        name="budgets_income_walk_through",
    ),
    path(
        "budgets/expenses/walk_through",
        budgets_expenses_walk_through,
        name="budgets_expenses_walk_through",
    ),
    path(
        "budgets/non_monthly_expenses/walk_through",
        budgets_non_monthly_expenses_walk_through,
        name="budgets_non_monthly_expenses_walk_through",
    ),
    path(
        "budgets/goals/walk_through",
        budgets_goals_walk_through,
    ...
    path(
        ...
        name="template_budget_update",
    ),
    path(
        "template_budget_delete/<int:pk>",
        TemplateDelete.as_view(),
        name="template_budget_delete",
    ),
    # Transaction urls :-
    ...
    path(
        "liability_detail/<int:pk>", LiabilityDetail.as_view(), name="liability_detail"
    ),
    path("liability_add/", LiabilityAdd.as_view(), name="liability_add"),
    path(
        "liability_update/<int:pk>", LiabilityUpdate.as_view(), name="liability_update"
    ),
    path(
        "liability_delete/<int:pk>", LiabilityDelete.as_view(), name="liability_delete"
    ),
    ...
    path(
        ...
        name="future_net_worth_calculator",
    ),
    # Rental Property Models Urls:-
    path(
        "rental_property_list/",
        RentalPropertyList.as_view(),
        name="rental_property_list",
    ),
    path(
        "rental_property_detail/<int:pk>",
        rental_property_details,
        name="rental_property_detail",
    ),
    path("rental_property_add/", rental_property_add, name="rental_property_add"),
    path(
        "rental_property_update/<int:pk>",
        rental_property_update,
        name="rental_property_update",
    ),
    path(
        "rental_property_delete/<int:pk>",
        rental_property_delete,
        name="rental_property_delete",
    ),
    # Property Urls:-
    ...
    path(
        ...
        MaintenanceAdd.as_view(),
        name="property_maintenance_add",
    ),
    path(
    ...
    path(
        "property/maintenance/details/<int:pk>",
        MaintenanceDetail.as_view(),
        name="property_maintenance_details",
    ),
    path(
        "property/maintenance/update/<int:pk>",
        MaintenanceUpdate.as_view(),
        name="property_maintenance_update",
    ),
    path(
        "property/maintenance/delete/<int:pk>",
        delete_maintenance,
        name="property_maintenance_delete",
    ),
    ...
    path(
        ...
        name="property_expense_update",
    ),
    path(
        "property/expense/delete/<int:pk>",
        delete_expense,
    ...
    path(
        "property/invoice/details/<int:pk>",
        property_invoice_detail,
        name="property_invoice_details",
    ),
    path(
        "property/invoice/update/<int:pk>",
    ...
    path(
        ...
        name="property_invoice_delete",
    ),
    path(
        "property/invoice/payment/<int:pk>",
        property_invoice_payment,
        name="property_invoice_payment",
    ),
    path(
        "property/invoice/payment_delete/<int:pk>/<int:payment_index>/<str:paid_amount>",
    ...
    path(
        "ai_feature/use-feature/<str:feature_name>/",
        ai_views.ai_use_feature,
        name="use_feature",
    ),
    path(
        "ai_feature/admin/update-feature-limit/",
        ai_views.ai_update_feature_limit,
        name="update_feature_limit",
    ),
    path(
        "ai_feature/choose-subscription/<int:plan_id>/",
