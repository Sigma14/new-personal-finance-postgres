...
urlpatterns = [
    ...
    path(
        "use-feature/<str:feature_name>/",
        ai_feature.views.use_feature,
        name="use_feature",
    ),
    path(
        "admin/update-feature-limit/",
        ai_feature.views.update_feature_limit,
        name="update_feature_limit",
    ),
    path(
        "choose-subscription/<int:plan_id>/",
        ai_feature.views.choose_subscription,
