...
SECRET_KEY = config("DJANGO_SECRET_KEY", default="django-insecure-default-key-for-development")
...
MIDDLEWARE = [
    ...
    "my_finance.middleware.SecurityHeadersMiddleware",
    "my_finance.middleware.RequestLoggingMiddleware",
    "my_finance.middleware.ErrorLoggingMiddleware",
]
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': config('SQL_DB_NAME', default='personal_finance'),
